...
- **规划中**:
  ...
  - OpenAI 兼容大模型服务 (v3.4) 🚧 ✨
  - 云端嵌入模型调用能力 (v3.5) 🚧 ✨
- **实现完成度**: 97%（基础功能100%，视频画面搜索已暂停，插件化架构、OpenAI大模型和云端嵌入模型规划中）
...
**最后更新时间**: 2026年3月26日
**更新内容**: v3.5 云端嵌入模型调用能力 - 新增LocalEmbeddingConfig和CloudEmbeddingConfig接口，支持OpenAI/DeepSeek/阿里云/Moonshot嵌入模型，新增4个云端嵌入模型专用错误码
