...
> **说明** ✨：新增云端 OpenAI 兼容 API 相关错误码（v1.2.1）
...
- **规划中**: 插件化架构与语雀数据源 (v3.0)、OpenAI 兼容大模型服务 (v3.4) ✨
- **实现完成度**: 97%（基础功能100%，视频画面搜索已暂停，插件化架构和OpenAI大模型规划中）
...
**最后更新时间**: 2026年2月28日
**更新内容**: v3.4 OpenAI兼容大模型服务 - 扩展provider字段支持cloud，新增CloudLLMConfig配置结构，API密钥加密存储和脱敏显示，测试接口扩展支持云端模型

---

**维护团队**: 小遥搜索开发组
**技术支持**: [GitHub Issues](https://github.com/your-repo/issues)
**文档版本**: v3.4.0 (OpenAI兼容大模型服务版)
**文档更新**: 2026-02-28