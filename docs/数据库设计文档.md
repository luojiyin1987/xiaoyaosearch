...
| video_frames | VideoFrameModel | video_frames | 🚧 设计中 | 2026-02-05 |
...
- v3.1 (视频帧支持): 设计完成，待实现 *(2026-02-05)*
...
11. **🚧 v3.1设计: 视频帧表和向量索引** - video_frames表设计和Faiss视频帧向量索引 *(2026-02-05)*
12. **🚧 v3.1设计: CN-CLIP多模态向量** - 图像和视频帧向量统一存储设计 *(2026-02-05)*
13. **🚧 v3.1设计: 视频关键帧提取配置** - app_settings表添加4项视频配置 *(2026-02-05)*
